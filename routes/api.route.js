...
// router.get("/User/home",authorization,UserController.Home)
...
router.post("/Call/create",authorization,CallController.create)
router.get("/Call/list",authorization,CallController.list)
router.get("/Call/view/:id",authorization,CallController.view)
router.patch("/Call/update/:id",authorization,CallController.update)
router.delete("/Call/delete/:id",authorization,CallController.remove)
router.delete("/Call/bulkdelete/:ids",authorization,CallController.bulkremove)

const ContactController          =  require('../controllers/Contact.js')
router.post("/Contactsync/create",authorization,ContactController.create)
router.get("/Contactsync/list",authorization,ContactController.list)
router.get("/Contactsync/checkPhoneNumberExistedORnot/:phonenumber",authorization,ContactController.checkPhoneNumberExistedORnot)
router.get("/Contactsync/view/:id",authorization,ContactController.view)
router.patch("/Contactsync/update/:id",authorization,ContactController.update)
router.delete("/Contactsync/delete/:id",authorization,ContactController.remove)
router.delete("/Contactsync/bulkdelete/:ids",authorization,ContactController.bulkremove)
...
router.get("/PostComment/checkPostCommentAccess/:post_id",authorization,PostCommentController.checkPostCommentAccess)
...
const InviteFriendController          =  require('../controllers/InviteFriend.js')
router.post("/InviteFriend/create",authorization,InviteFriendController.create)
router.get("/InviteFriend/list",authorization,InviteFriendController.list)
router.get("/InviteFriend/checkInvitedorNot/:invite_to_number_or_id",authorization,InviteFriendController.view)
router.patch("/InviteFriend/update/:id",authorization,InviteFriendController.update)
router.delete("/InviteFriend/delete/:id",authorization,InviteFriendController.remove)
router.delete("/InviteFriend/bulkdelete/:ids",authorization,InviteFriendController.bulkremove)
